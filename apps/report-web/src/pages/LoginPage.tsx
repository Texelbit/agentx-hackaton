...
import { Loader2, LifeBuoy, Lock, Mail } from 'lucide-react';
...
export function LoginPage() {
  ...
  return (
    <div className="relative flex h-full items-center justify-center overflow-hidden bg-zinc-950 p-6">
      ...
      <div className="pointer-events-none absolute right-1/4 bottom-1/4 h-96 w-96 rounded-full bg-emerald-600/15 blur-3xl" />
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-8 shadow-2xl backdrop-blur-xl">
          <div className="mb-6 space-y-1">
            ...
            <p className="text-sm text-zinc-500">
              Our SRE Agent will take it from there.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileHover={{ y: -1 }}
              disabled={loading}
              className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-brand-600 text-sm font-medium text-white shadow-glow transition hover:bg-brand-500 disabled:opacity-50"
            >
              {loading ? (
